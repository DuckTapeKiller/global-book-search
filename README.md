[![GitHub Repo stars](https://img.shields.io/github/stars/DuckTapeKiller/global-book-search?style=flat&logo=obsidian&color=%23483699)](https://github.com/DuckTapeKiller/global-book-search/stargazers)
[![GitHub issues](https://img.shields.io/github/issues/DuckTapeKiller/global-book-search?logo=obsidian&color=%23483699)](https://github.com/DuckTapeKiller/global-book-search/issues)
[![GitHub closed issues](https://img.shields.io/github/issues-closed/DuckTapeKiller/global-book-search?logo=obsidian&color=%23483699)](https://github.com/DuckTapeKiller/global-book-search/issues?q=is%3Aissue+is%3Aclosed)
[![GitHub manifest version](https://img.shields.io/github/manifest-json/v/DuckTapeKiller/global-book-search?logo=obsidian&color=%23483699)](https://github.com/DuckTapeKiller/global-book-search/blob/main/manifest.json)
...
2. Create a new directory named `global-book-search`.
3. Download the latest release files from the GitHub repository.
4. Place the following three files into the `global-book-search` folder:
   - `main.js`
   - `manifest.json`
   - `styles.css`
5. Open Obsidian and enable **Global Book Search** in the Community Plugins settings.
